...
export default function ChatPage({ params }: TChatPageProps) {
  ...
  const active_chat = chats.find((chat) => chat._id === params.chatId)
  const chat_title = active_title || active_chat?.title || 'Chat'
          ...
          <div className="flex items-center justify-between border-b border-slate-200 bg-white/90 px-6 py-4">
            ...
            <div className="text-center">
              ...
              <p className="text-xs text-slate-500">
                {active_chat?.message_count || 0} messages
              </p>
            </div>
            <div className="w-14" />
          </div>
